...
try{
	...
	$sql = "SELECT  lesson_id , quiz_pass FROM `quiz_record` where member_id = :member_id group by lesson_id having lesson_id >5 && lesson_id <11 && quiz_pass = 1 ORDER BY lesson_id ASC"  ;
