...
try{
    ...
    //1.sql指令
	$sql = "SELECT  lesson_id , quiz_pass FROM `quiz_record` where member_id = :member_id group by lesson_id having lesson_id <=5 && quiz_pass is not null ORDER BY lesson_id ASC"  ;
    //2.要資料庫準備接收指令
