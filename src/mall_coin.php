...
$update_mem_coin = $pdo->prepare($update_mem_coin_sql);
$update_mem_coin->bindValue(":coin",$_GET["coin"]);
$update_mem_coin->bindValue(":member_id",$_SESSION["member_id"]);

$update_mem_coin->execute();
