...
try{
  ...
  require_once("connect_cgd101g1.php");
    ...
    // 含留言內容、留言編號
    $sql = "SELECT post.post_id,post.post_date,member.member_name,member.role,message.message_id, message.message_txt, message.message_date FROM `message` LEFT JOIN post ON message.post_id = post.post_id LEFT JOIN member on member.member_id = message.member_id WHERE post.post_type=:post_type;";
