...
(2, '2022-06-04 15:59:05', '您好，N5單字第8題的答案是あか。', 1, 3, 2, 1),
...
(31, '2022-06-23 01:28:40', '?', 1, 1, 2, 1),
(32, '2022-06-23 01:30:28', '請問是甚麼問題?', 1, 1, 2, 1);
...
CREATE TABLE `error` (
  ...
  `error_status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Not Null(0-未審核,1-已審核)',
...
(2, 2, '換裝壞了', '購買裝備後，無法正常穿戴', './images/report/error2.png', '0', '2022-06-03 16:47:02.000000'),
...
CREATE TABLE `item_record` (
  ...
  `item_on` int NOT NULL DEFAULT '0' COMMENT '0-沒穿、1-穿上',
...
(5, 1, 3, 1, '2022-05-08 19:03:07.000000'),
(6, 1, 4, 0, '2022-05-09 19:03:07.000000'),
(7, 1, 5, 0, '2022-05-10 19:03:07.000000'),
(8, 1, 6, 0, '2022-05-11 19:03:07.000000'),
(9, 1, 7, 0, '2022-05-12 19:03:07.000000'),
(10, 1, 8, 0, '2022-05-13 19:03:07.000000'),
(11, 1, 9, 0, '2022-05-14 19:03:07.000000'),
(12, 1, 10, 1, '2022-05-15 19:03:07.000000'),
(13, 1, 11, 0, '2022-05-16 19:03:07.000000'),
(14, 1, 12, 0, '2022-05-17 19:03:07.000000'),
(15, 1, 13, 0, '2022-05-18 19:03:07.000000'),
(16, 1, 14, 0, '2022-05-19 19:03:07.000000'),
(17, 1, 15, 0, '2022-05-20 19:03:07.000000'),
(18, 1, 16, 0, '2022-05-21 19:03:07.000000'),
(19, 1, 17, 0, '2022-05-22 19:03:07.000000'),
(20, 1, 18, 0, '2022-05-23 19:03:07.000000'),
(21, 1, 19, 0, '2022-05-24 19:03:07.000000'),
(22, 1, 20, 0, '2022-05-25 19:03:07.000000'),
(23, 1, 21, 0, '2022-05-26 19:03:07.000000'),
(24, 1, 22, 0, '2022-05-27 19:03:07.000000');
...
(26, '日本文化', './images/payement_map.png', 300, '日本文化\r\n幫助大家理解日本文化，宛如置身日\r\n本社會一般，感受真實日本的普遍樣\r\n貌。', 2, 1),
(27, '情境會話', './images/payement_map.png', 300, '情境會話\r\n日本點餐、參拜、泡溫泉相關情境對\r\n話，讓你自助旅遊也不怕！', 3, 1);
...
CREATE TABLE `member` (
  ...
  `role` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT './images/char_00_1.png' COMMENT 'Not Null',
  `map_img` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT './images/home_lesson_island1.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `member` (`member_id`, `member_name`, `account`, `password`, `member_status`, `coin`, `level`, `role`, `map_img`) VALUES
(1, 'Kenny', 'abc@gmail.com', 'aaaAAA111', '1', 1000, 4, './images/role/1.png', './images/memMap/1.jpeg'),
(2, 'Jerry', 'def@gmail.com', 'bbbBBB111', '1', 100, 1, './images/char_00_1.png', './images/home_lesson_island1.png'),
(3, 'Bill', 'efg@gmail.com', 'cccCCC111', '0', 0, 1, './images/char_00_1.png', './images/home_lesson_island1.png'),
(7, 'Triangle', 'tri@gmail.com', 'TRItri123', '1', 666, 1, './images/char_00_1.png', './images/home_lesson_island1.png'),
(8, 'Bob', 'Bob@gmail.com', 'Bob12345', '1', 0, 1, './images/char_00_1.png', './images/home_lesson_island1.png'),
(9, 'Curry', 'Curry@gmail.com', 'Curry12345', '1', 0, 1, './images/char_00_1.png', './images/home_lesson_island1.png'),
(10, 'Peter', '123@gmail.com', 'Peter123', '1', 6900, 1, './images/char_00_1.png', './images/home_lesson_island1.png'),
(12, 'yunyun', 'Yun@gmail.com', 'Yun1234567', '1', 2190, 1, './images/char_00_1.png', './images/home_lesson_island1.png'),
(14, 'Sarah', 'Sarah@gmail.com', 'Sarah111', '1', 10000, 6, './images/char_00_1.png', './images/home_lesson_island1.png');
...
(2, '2022-06-03 16:33:54', 2, 1, 'QQ我沒報名到JPLT考試'),
(3, '2022-06-02 16:33:54', 3, 1, '+1 我也想要有個伴一起讀書'),
(4, '2022-06-10 19:22:01', 2, 4, '背就對了!加油'),
(5, '2022-06-10 19:22:01', 1, 4, '背就對了!加油');
...
(9, 9, '2022-06-23 15:39:31', '50音有甚麼推薦教材嗎?想自學50音', '50音有甚麼推薦教材嗎?', 1, 1),
(10, 12, '2022-06-23 15:39:31', '50音片假名好難背啊啊啊啊', '片假名練習', 1, 1);
...
INSERT INTO `quiz_record` (`quiz_record_id`, `lesson_id`, `member_id`, `quiz_score`, `quiz_pass`, `quiz_getcoin`, `quiz_time`) VALUES
(1, 1, 1, 90, 1, 90, '2022-06-04 15:22:38.000000'),
(2, 2, 2, 80, 1, 80, '2022-06-05 15:22:38.000000'),
(3, 3, 3, 50, 0, 0, '2022-06-01 03:23:01.000000'),
(4, 3, 3, 50, 0, 0, '2022-06-01 03:23:01.000000'),
(5, 2, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
(6, 3, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
(7, 4, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
(8, 5, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
(9, 6, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
(10, 7, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
(11, 8, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
(12, 9, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
(13, 10, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
(14, 11, 1, 90, 1, 90, '2022-06-10 14:32:14.000000'),
...
--
ALTER TABLE `ask_log`
  MODIFY `ask_id` int NOT NULL AUTO_INCREMENT COMMENT 'Not Null(PK,AI)', AUTO_INCREMENT=48;
...
--
ALTER TABLE `error`
  MODIFY `error_id` int NOT NULL AUTO_INCREMENT COMMENT 'Not Null(PK,AI)', AUTO_INCREMENT=18;
...
--
ALTER TABLE `lesson`
  MODIFY `lesson_id` int NOT NULL AUTO_INCREMENT COMMENT 'Not Null(PK,AI)', AUTO_INCREMENT=28;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `lesson_record`
--
ALTER TABLE `lesson_record`
  MODIFY `lesson_order_id` int NOT NULL AUTO_INCREMENT COMMENT 'Not Null(PK, AI)', AUTO_INCREMENT=21;
...
--
ALTER TABLE `post`
  MODIFY `post_id` int NOT NULL AUTO_INCREMENT COMMENT 'Not Null(PK,AI)', AUTO_INCREMENT=11;
